...
// // Test to Create VolumeGroup with QoS Performance Policy
// func TestAccVolumeGroup_CreateWithQosPolicy(t *testing.T) {
// 	if os.Getenv("TF_ACC") == "" {
// 		t.Skip("Dont run with units tests because it will try to create the context")
// 	}
...
// 		Steps: []resource.TestStep{
// 			{
// 				Config: ProviderConfigForTesting + VolumeGroupParamsCreateWithQosPolicy,
// 				Check: resource.ComposeTestCheckFunc(
// 					resource.TestCheckResourceAttr("powerstore_volumegroup.test", "name", "tf_volume_group_new"),
// 					resource.TestCheckResourceAttr("powerstore_volumegroup.test", "description", "Creating Volume Group with QoS"),
// 					resource.TestCheckResourceAttrSet("powerstore_volumegroup.test", "qos_performance_policy_id"),
// 				),
// 			},
// 		},
// 	})
...
// // Test to Update VolumeGroup to add QoS Performance Policy
// func TestAccVolumeGroup_UpdateAddQosPolicy2(t *testing.T) {
// 	if os.Getenv("TF_ACC") == "" {
// 		t.Skip("Dont run with units tests because it will try to create the context")
// 	}
...
// 			},
// 			{
// 				Config: ProviderConfigForTesting + VolumeGroupParamsUpdateAddQosPolicy,
// 				Check: resource.ComposeTestCheckFunc(
// 					resource.TestCheckResourceAttr("powerstore_volumegroup.test", "name", "tf_volume_group_new"),
// 					resource.TestCheckResourceAttrSet("powerstore_volumegroup.test", "qos_performance_policy_id"),
// 				),
...
// // Test to Update VolumeGroup to remove QoS Performance Policy
// func TestAccVolumeGroup_UpdateRemoveQosPolicy(t *testing.T) {
// 	if os.Getenv("TF_ACC") == "" {
// 		t.Skip("Dont run with units tests because it will try to create the context")
// 	}
...
// 			},
// 			{
// 				Config: ProviderConfigForTesting + VolumeGroupParamsUpdateRemoveQosPolicy,
// 				Check: resource.ComposeTestCheckFunc(
// 					resource.TestCheckResourceAttr("powerstore_volumegroup.test", "name", "tf_volume_group_new"),
// 					resource.TestCheckResourceAttr("powerstore_volumegroup.test", "qos_performance_policy_id", ""),
// 				),
// 			},
// 		},
// 	})
...
// Pre-requisite: QoS policy for volume group tests
var PreReqQosPolicyForVolumeGroup = `
resource "powerstore_io_limit_rule" "vg_qos_rule" {
	name     = "tf_acc_vg_qos_rule"
	type     = "Absolute"
	max_iops = 1000
	max_bw   = 2000
}

resource "powerstore_qos_policy" "vg_qos" {
	name             = "tf_acc_vg_qos_policy"
	type             = "QoS"
	io_limit_rule_id = powerstore_io_limit_rule.vg_qos_rule.id
}
`

var VolumeGroupParamsCreateWithQosPolicy = PreReqQosPolicyForVolumeGroup + `
resource "powerstore_volumegroup" "test" {
  name = "tf_volume_group_new"
  description = "Creating Volume Group with QoS"
  is_write_order_consistent = false
  qos_performance_policy_id = powerstore_qos_policy.vg_qos.id
}
`

var VolumeGroupParamsUpdateAddQosPolicy = PreReqQosPolicyForVolumeGroup + `
resource "powerstore_volumegroup" "test" {
  name = "tf_volume_group_new"
  description = "Updating Volume Group with QoS"
  is_write_order_consistent = false
  qos_performance_policy_id = powerstore_qos_policy.vg_qos.id
}
`

var VolumeGroupParamsUpdateRemoveQosPolicy = PreReqQosPolicyForVolumeGroup + `
resource "powerstore_volumegroup" "test" {
  depends_on = [powerstore_qos_policy.vg_qos]
  name = "tf_volume_group_new"
  description = "Updating Volume Group without QoS"
  is_write_order_consistent = false
