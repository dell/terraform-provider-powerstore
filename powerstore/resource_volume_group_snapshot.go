	...
	resp.Schema = schema.Schema{
		...
		Attributes: map[string]schema.Attribute{
			...
			"volume_group_name": schema.StringAttribute{
				Optional:            true,
				Description:         "Name of the volume to take snapshot.Conflicts with `volume_group_id`.Cannot be updated.",
				MarkdownDescription: "Name of the volume to take snapshot.Conflicts with `volume_group_id`.Cannot be updated.",
				Validators: []validator.String{
					stringvalidator.LengthAtLeast(1),
