...
// // Test to Create Volume with QoS Performance Policy
// func TestAccVolume_CreateWithQosPolicy(t *testing.T) {
// 	if os.Getenv("TF_ACC") == "" {
// 		t.Skip("Dont run with units tests because it will try to create the context")
// 	}
...
// 		Steps: []resource.TestStep{
// 			{
// 				Config: ProviderConfigForTesting + VolumeParamsWithQosPolicy,
// 				Check: resource.ComposeTestCheckFunc(
// 					resource.TestCheckResourceAttr("powerstore_volume.volume_create_test", "name", "test_acc_cvol"),
// 					resource.TestCheckResourceAttrSet("powerstore_volume.volume_create_test", "qos_performance_policy_id"),
// 				),
// 			},
// 		},
// 	})
...
// // Test to Update Volume to add QoS Performance Policy
// func TestAccVolume_UpdateAddQosPolicy(t *testing.T) {
// 	if os.Getenv("TF_ACC") == "" {
// 		t.Skip("Dont run with units tests because it will try to create the context")
// 	}
...
// 			},
// 			{
// 				Config: ProviderConfigForTesting + VolumeParamsUpdateAddQosPolicy,
// 				Check: resource.ComposeTestCheckFunc(
// 					resource.TestCheckResourceAttr("powerstore_volume.volume_create_test", "name", "test_acc_cvol"),
// 					resource.TestCheckResourceAttrSet("powerstore_volume.volume_create_test", "qos_performance_policy_id"),
// 				),
...
// // Test to Update Volume to remove QoS Performance Policy
// func TestAccVolume_UpdateRemoveQosPolicy(t *testing.T) {
// 	if os.Getenv("TF_ACC") == "" {
// 		t.Skip("Dont run with units tests because it will try to create the context")
// 	}
...
// 			},
// 			{
// 				Config: ProviderConfigForTesting + VolumeParamsUpdateRemoveQosPolicy,
// 				Check: resource.ComposeTestCheckFunc(
// 					resource.TestCheckResourceAttr("powerstore_volume.volume_create_test", "name", "test_acc_cvol"),
// 					resource.TestCheckResourceAttr("powerstore_volume.volume_create_test", "qos_performance_policy_id", ""),
// 				),
// 			},
// 		},
// 	})
...
// Pre-requisite: QoS policy for volume tests
var PreReqQosPolicyForVolume = `
resource "powerstore_io_limit_rule" "vol_qos_rule" {
	name     = "tf_acc_vol_qos_rule"
	type     = "Absolute"
	max_iops = 1000
	max_bw   = 2000
}

resource "powerstore_qos_policy" "vol_qos" {
	name             = "tf_acc_vol_qos_policy"
	type             = "QoS"
	io_limit_rule_id = powerstore_io_limit_rule.vol_qos_rule.id
}
`

var VolumeParamsWithQosPolicy = PreReqQosPolicyForVolume + `
resource "powerstore_volume" "volume_create_test" {
	name                        = "test_acc_cvol"
	size                        = 2.5
	capacity_unit               = "GB"
	qos_performance_policy_id   = powerstore_qos_policy.vol_qos.id
}
`

var VolumeParamsUpdateAddQosPolicy = PreReqQosPolicyForVolume + `
resource "powerstore_volume" "volume_create_test" {
	name                        = "test_acc_cvol"
	size                        = 2.5
	capacity_unit               = "GB"
...
var VolumeParamsUpdateRemoveQosPolicy = PreReqQosPolicyForVolume + `
resource "powerstore_volume" "volume_create_test" {
	name                        = "test_acc_cvol"
	size                        = 2.5
	capacity_unit               = "GB"
