...
// // Test to Create FileSystem with File_Performance QoS Policy
// func TestAccFileSystem_CreateWithQosPolicy(t *testing.T) {
// 	if os.Getenv("TF_ACC") == "" {
// 		t.Skip("Dont run with units tests because it will try to create the context")
// 	}
...
// 		Steps: []resource.TestStep{
// 			{
// 				Config: ProviderConfigForTesting + FsParamsWithQosPolicy,
// 				Check: resource.ComposeTestCheckFunc(
// 					resource.TestCheckResourceAttr("powerstore_filesystem.test_fs_create", "name", "test_fs"),
// 					resource.TestCheckResourceAttrSet("powerstore_filesystem.test_fs_create", "performance_policy_id"),
// 				),
// 			},
// 		},
// 	})
...
// // Test to Update FileSystem to add File_Performance QoS Policy
// func TestAccFileSystem_UpdateAddQosPolicy(t *testing.T) {
// 	if os.Getenv("TF_ACC") == "" {
// 		t.Skip("Dont run with units tests because it will try to create the context")
// 	}
...
// 			},
// 			{
// 				Config: ProviderConfigForTesting + FsParamsUpdateAddQosPolicy,
// 				Check: resource.ComposeTestCheckFunc(
// 					resource.TestCheckResourceAttr("powerstore_filesystem.test_fs_create", "name", "test_fs"),
// 					resource.TestCheckResourceAttrSet("powerstore_filesystem.test_fs_create", "performance_policy_id"),
// 				),
...
// // Test to Update FileSystem to remove File_Performance QoS Policy
// func TestAccFileSystem_UpdateRemoveQosPolicy(t *testing.T) {
// 	if os.Getenv("TF_ACC") == "" {
// 		t.Skip("Dont run with units tests because it will try to create the context")
// 	}
...
// 			},
// 			{
// 				Config: ProviderConfigForTesting + FsParamsUpdateRemoveQosPolicy,
// 				Check: resource.ComposeTestCheckFunc(
// 					resource.TestCheckResourceAttr("powerstore_filesystem.test_fs_create", "name", "test_fs"),
// 					resource.TestCheckResourceAttr("powerstore_filesystem.test_fs_create", "performance_policy_id", ""),
// 				),
// 			},
// 		},
// 	})
...
// Pre-requisite: File_Performance QoS policy for filesystem tests
var PreReqQosPolicyForFilesystem = `
resource "powerstore_file_io_limit_rule" "fs_qos_rule" {
	name   = "tf_acc_fs_qos_rule"
	max_bw = 100
}

resource "powerstore_qos_policy" "fs_qos" {
	name                  = "tf_acc_fs_qos_policy"
	type                  = "File_Performance"
	file_io_limit_rule_id = powerstore_file_io_limit_rule.fs_qos_rule.id
}
`

var FsParamsWithQosPolicy = PreReqQosPolicyForFilesystem + `
resource "powerstore_filesystem" "test_fs_create" {
	name                 = "test_fs"
	description = "testing file system with QoS"
	size      = 5
	nas_server_id = "` + nasServerID + `"
	flr_attributes = {
	  mode = "Enterprise"
	...
	is_async_mtime_enabled = true
	file_events_publishing_mode = "All"
	performance_policy_id = powerstore_qos_policy.fs_qos.id
}
`

var FsParamsUpdateAddQosPolicy = PreReqQosPolicyForFilesystem + `
resource "powerstore_filesystem" "test_fs_create" {
	name                 = "test_fs"
	description = "testing file system"
	size      = 5
...
var FsParamsUpdateRemoveQosPolicy = PreReqQosPolicyForFilesystem + `
resource "powerstore_filesystem" "test_fs_create" {
	depends_on = [powerstore_qos_policy.fs_qos]
	name                 = "test_fs"
	description = "testing file system"
	size      = 5
	nas_server_id = "` + nasServerID + `"
