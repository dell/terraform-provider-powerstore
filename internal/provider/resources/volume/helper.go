...
func updateVolState(volState *model, volResponse pstore.Volume, hostMapping []pstore.HostVolumeMapping, volGroupMapping pstore.VolumeGroups, volPlan *model, operation operation) {
	...
	if operation == operationCreate || operation == operationUpdate {
		volState.MinimumSize = types.Int64Value(volPlan.MinimumSize.ValueInt64())
		volState.SectorSize = types.Int64Value(volPlan.SectorSize.ValueInt64())
		volState.ApplianceName = types.StringValue(volPlan.ApplianceName.ValueString())
		volState.HostName = types.StringValue(volPlan.HostName.ValueString())
		volState.HostGroupName = types.StringValue(volPlan.HostGroupName.ValueString())
		volState.VolumeGroupName = types.StringValue(volPlan.VolumeGroupName.ValueString())
...
func updateVol(ctx context.Context, client *powerstore.Client, planVol, stateVol model) ([]string, []string, []string) {
...
func validateUpdate(ctx context.Context, planVol, stateVol model) (bool, string) {
...
func fetchByName(client *powerstore.Client, plan *model) (bool, string) {
...
func detachHostFromVolume(stateVol, planVol model, client *powerstore.Client, volID string) error {
	var err error
...
func attachHostFromVolume(stateVol, planVol model, client *powerstore.Client, volID string) error {
	var err error
	if (stateVol.HostID.ValueString() == "" && planVol.HostID.ValueString() != "") || (stateVol.HostGroupID.ValueString() == "" && planVol.HostGroupID.ValueString() != "") {
...
func attachVolumeGroup(ctx context.Context, planVol model, client *powerstore.Client, volID string) error {
...
func detachVolumeGroup(ctx context.Context, stateVol model, client *powerstore.Client, volID string) error {
...
func modifyVolume(planVol model, valInBytes int64, volID string, client *powerstore.Client) error {
