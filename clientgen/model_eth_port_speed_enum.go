...
func (v *EthPortSpeedEnum) UnmarshalJSON(src []byte) error {
	var value string
	err := json.Unmarshal(src, &value)
	if err != nil {
		return err
	}
	enumTypeValue := EthPortSpeedEnum(value)
	for _, existing := range AllowedEthPortSpeedEnumEnumValues {
	...
	return fmt.Errorf("%+v is not a valid EthPortSpeedEnum", value)
}

// NewEthPortSpeedEnumFromValue returns a pointer to a valid EthPortSpeedEnum
// for the value passed as argument, or an error if the value passed is not allowed by the enum
func NewEthPortSpeedEnumFromValue(v string) (*EthPortSpeedEnum, error) {
	ev := EthPortSpeedEnum(v)
	if ev.IsValid() {
		return &ev, nil
	} else {
		return nil, fmt.Errorf("invalid value '%v' for EthPortSpeedEnum: valid values are %v", v, AllowedEthPortSpeedEnumEnumValues)
	}
}

// IsValid return true if the value is valid for the enum, false otherwise
func (v EthPortSpeedEnum) IsValid() bool {
	for _, existing := range AllowedEthPortSpeedEnumEnumValues {
		if existing == v {
			return true
		}
...
// Ptr returns reference to EthPortSpeedEnum value
func (v EthPortSpeedEnum) Ptr() *EthPortSpeedEnum {
	return &v
}

type NullableEthPortSpeedEnum struct {
	value *EthPortSpeedEnum
	isSet bool
}

func (v NullableEthPortSpeedEnum) Get() *EthPortSpeedEnum {
	return v.value
}

func (v *NullableEthPortSpeedEnum) Set(val *EthPortSpeedEnum) {
	v.value = val
	v.isSet = true
}

func (v NullableEthPortSpeedEnum) IsSet() bool {
	return v.isSet
}

func (v *NullableEthPortSpeedEnum) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEthPortSpeedEnum(val *EthPortSpeedEnum) *NullableEthPortSpeedEnum {
	return &NullableEthPortSpeedEnum{value: val, isSet: true}
}

func (v NullableEthPortSpeedEnum) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEthPortSpeedEnum) UnmarshalJSON(src []byte) error {
	v.isSet = true
