...
build_client: build_spec
	${OPENAPI_CMD} generate -i clientgen_utils/openapi_specs/spec_4_1_filtered.json \
		...
		--global-property apis,models,supportingFiles=client.go:README.md:configuration.go:response.go:utils.go,modelTests=false,apiTests=false,modelDocs=false,apiDocs=false \
