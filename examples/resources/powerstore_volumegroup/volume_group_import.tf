...
# Step 2 - To check the id of the volume group we can make Get request to volume group endpoint. eg. https://10.0.0.1/api/rest/policy which will return list of all volume group ids.
